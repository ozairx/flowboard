...
router.patch('/:boardId/lists/:listId/cards/:cardId', cardController.updateCard);
router.delete('/:boardId/lists/:listId/cards/:cardId', cardController.deleteCard);
router.patch('/:boardId/lists/:listId/cards/reorder', cardController.reorderCards);
